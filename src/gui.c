...
void gui_draw_hud()
{
	...
	gf2d_sprite_draw(
		...
		&color,
		0);
	gui_draw_percent_bar_horizontal(gf2d_rect(495, 680, 145, 10), gui.healthPercent, vector4d((1 - gui.healthPercent) * 0, gui.healthPercent * 255, 0, 0), vector4d(128, 0, 0, 128), 0);
	...
	gf2d_text_draw_line("Health", FT_Normal, gf2d_color8(0, 255, 0, 0), vector2d(495, 665));
